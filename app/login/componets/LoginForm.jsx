  ...
  return (
    <div className="flex-1 sm:p-12 px-4 py-8 flex flex-col overflow-y-auto">
      ...
      <section className="mx-auto py-10 w-full sm:w-5/6 md:w-3/4 lg:w-2/3 xl:w-1/2 flex-1 flex flex-col justify-center">
        ...
        <form
          className="py-8 sm:py-12 flex flex-col gap-4 sm:gap-6 w-full"
          onSubmit={handleSubmit}
        >
          <div
            className={`flex items-center py-2 sm:py-3 px-2 sm:px-6 rounded-md myInput ${
              hasError.username === 1
                ? "hasError"
                : hasError.username === 2
                ? "good"
          ...
          <div
            className={`flex items-center relative py-2 sm:py-3 px-2 sm:px-6 rounded-md  ${
              hasError.password === 1
                ? "hasError"
                : hasError.password === 2
                ? "good"
          ...
          >
            ...
            {seePassord && (
              <FaEyeSlash
                ...
                onClick={() => setSeePassord(!seePassord)}
              />
            )}
            {!seePassord && (
              <FaEye
          ...
          <button
            type="submit"
            className={`rounded-md py-4 sm:py-5 grid place-items-center font-semibold ${
              canProceed
        ...
        <p className="text-center sm:text-base text-sm">
          ...
          <Link href={"/signup"} className="text-themeGreen">
            Sign up
          </Link>{" "}
        </p>
      </section>
